...
Ask the user what type of document they're working with using AskUserQuestion. Present these options:
...
Use the Read tool to load exactly two files — no more.

**Always load (universal patterns):**
```
references/base-patterns.md
```
...
|---|---|
| Resume | `references/resume-cover-letter.md` |
| Cover letter | `references/resume-cover-letter.md` |
| Blog post | `references/blog.md` |
| News / editorial | `references/news-article.md` |
| Marketing copy | `references/marketing.md` |

The `references/` directory is in the same folder as this SKILL.md file. Use the Read tool with the path relative to this skill's directory.
